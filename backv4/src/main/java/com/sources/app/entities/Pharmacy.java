...
/**
 * Representa una entidad de farmacia mapeada a la tabla PHARMACY. Contiene
 * información sobre farmacias, como nombre, dirección, teléfono, email y
 * estado.
 */
@Entity
@Table(name = "PHARMACY")
public class Pharmacy {
    ...
    /**
     * El nombre de la farmacia. No puede ser nulo y tiene una longitud máxima
     * de 100 caracteres.
     */
    ...
    /**
     * La dirección de la farmacia. No puede ser nulo y tiene una longitud
    ...
    /**
     * El número de teléfono de la farmacia. No puede ser nulo.
     */
    @Column(name = "PHONE", nullable = false)
    private Long phone;

    /**
     * La dirección de correo electrónico de la farmacia. Puede ser nulo.
     */
    @Column(name = "EMAIL")
    private String email;

    /**
     * Indica si la farmacia está habilitada o activa. Típicamente 1 para
     * habilitado, 0 para deshabilitado. No puede ser nulo.
     */
    @Column(name = "ENABLED", nullable = false)
    private Integer enabled;

    /**
     * Constructor por defecto para la entidad Pharmacy. Requerido por JPA.
     */
    ...
    public boolean equals(Object o) {
        ...
        // Comparar por identificador si está presente
        if (this.idPharmacy == null || that.idPharmacy == null) {
            return false;
        }
        return this.idPharmacy.equals(that.idPharmacy);
    }

    @Override
    public int hashCode() {
        return java.util.Objects.hash(idPharmacy);
    }
}

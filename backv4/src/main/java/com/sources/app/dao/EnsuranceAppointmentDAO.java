...
/**
 * Data Access Object (DAO) para gestionar las entidades EnsuranceAppointment
 * (Citas de Seguro). Proporciona métodos para operaciones CRUD (Crear, Leer,
 * Actualizar, Eliminar) sobre las citas.
 */
public class EnsuranceAppointmentDAO {
     ...
     * (puede ser diferente al ID interno).
     ...
     * @return El objeto EnsuranceAppointment encontrado, o null si no se
    ...
    /**
     * Busca una cita de seguro por el ID que tiene asignado en el sistema del
     * hospital.
     *
    ...
    /**
     * Busca todas las citas de seguro asociadas a un ID de usuario específico,
     * ordenadas por fecha descendente.
     *
     * @param idUser El ID del usuario cuyas citas se quieren buscar.
     * @return Una lista de objetos EnsuranceAppointment asociados al usuario, o
    ...
    /**
     * Recupera todas las citas de seguro de la base de datos, ordenadas por
     * fecha descendente.
     *
     * @return Una lista de todos los objetos EnsuranceAppointment, o null si
     * ocurre un error.
     */
     ...
     *
     * @param appointment El objeto EnsuranceAppointment con los datos
     * actualizados.
     * @return El objeto EnsuranceAppointment actualizado, o null si ocurre un
     * error.
     */
    ...
    /**
     * Elimina una cita de seguro de la base de datos utilizando el ID del
     * sistema del hospital.
     *
     * @param hospitalAppointmentId El ID de la cita en el sistema del hospital.
     * @return true si la cita fue eliminada con éxito, false en caso contrario
     * (p. ej., no se encontró la cita).
     */
    ...
    /**
     * Busca todas las citas de seguro que ocurren en una fecha específica
     * (considerando el día completo).
     *
     * @param date La fecha para la cual buscar citas.
     * @return Una lista de objetos EnsuranceAppointment para la fecha dada, o
     * null si ocurre un error.
     */
    ...
    /**
     * Busca todas las citas de seguro programadas para el día de hoy. Es un
     * método de conveniencia que llama a findByDate con la fecha actual.
     *
     * @return Una lista de objetos EnsuranceAppointment para hoy, o null si
     * ocurre un error.
     */

...
class HttpClientUtilTest {
    ...
    private MockedStatic<HttpClientUtil> mockedClient;
    ...
    void setUp() throws IOException {
        // Mockear punto de extensión de HttpClientUtil para inyectar nuestra conexión
        mockedClient = Mockito.mockStatic(HttpClientUtil.class, Mockito.CALLS_REAL_METHODS);
        mockedClient.when(() -> HttpClientUtil.open(anyString())).thenReturn(mockConnection);
    ...
    void get_Success() throws IOException {
        ...
        String result = HttpClientUtil.get(TEST_URL);
    ...
    void post_Success() throws IOException {
        ...
        String result = HttpClientUtil.post(TEST_URL, JSON_BODY);
    ...
    void put_Success() throws IOException {
        setupMockResponse(200, SUCCESS_RESPONSE, "");
        String result = HttpClientUtil.put(TEST_URL, JSON_BODY);
    ...
    void delete_Success() throws IOException {
        ...
        String result = HttpClientUtil.delete(TEST_URL);

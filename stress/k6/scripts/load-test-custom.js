...
// Read VUS from environment, default to 50
const VUS = parseInt(__ENV.VUS || '50');
const BASE_VUS = Math.floor(VUS * 0.2); // 20% of target
const MID_VUS = Math.floor(VUS * 0.5);  // 50% of target
...
export function setup() {
  console.log('=== LOAD TEST (CUSTOM) STARTING ===');
  console.log(`BackV4 URL: ${BACKV4_URL}`);
  console.log(`BackV5 URL: ${BACKV5_URL}`);
  console.log(`Target VUS: ${VUS} (Base: ${BASE_VUS}, Mid: ${MID_VUS})`);
}

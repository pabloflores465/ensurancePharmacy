...
<template>
  ...
  >
    ...
    <button
      ...
      :class="[
        'px-2 py-2',
        search ? 'bg-accent hover:bg-h-accent' : 'hover:bg-h-background',
      ]"
    >
      <svg
        :class="[search ? 'text-dark' : 'text-primary']"
        xmlns="http://www.w3.org/2000/svg"
        height="40px"
        viewBox="0 -960 960 960"
        width="40px"
    ...
    >
      <svg
        :class="[router.path === '/signup' ? 'text-dark' : 'text-primary']"
        xmlns="http://www.w3.org/2000/svg"
        height="40px"
        viewBox="0 -960 960 960"
        width="40px"
    ...
    >
      <svg
        :class="[router.path === '/login' ? 'text-dark' : 'text-primary']"
        xmlns="http://www.w3.org/2000/svg"
        height="40px"
        viewBox="0 -960 960 960"
        width="40px"
    ...
    >
      <svg
        :class="[currentId === 1 ? 'text-dark' : 'text-primary']"
        xmlns="http://www.w3.org/2000/svg"
        height="40px"
        viewBox="0 -960 960 960"
        width="40px"
    ...
    <NuxtLink
      ...
      :class="[
        'px-2 py-2',
        router.path === '/policies'
          ? 'bg-accent hover:bg-h-accent'
          : 'hover:bg-h-background',
      ]"
    >
      <svg
        :class="[router.path === '/policies' ? 'text-dark' : 'text-primary']"
        xmlns="http://www.w3.org/2000/svg"
        height="40px"
        viewBox="0 -960 960 960"
        width="40px"
    ...
    >
      <svg
        :class="[currentId === 3 ? 'text-dark' : 'text-primary']"
        xmlns="http://www.w3.org/2000/svg"
        height="40px"
        viewBox="0 -960 960 960"
        width="40px"
    ...
    <button
      ...
      :class="[
        'px-2 py-2',
        edit ? 'bg-accent hover:bg-h-accent' : 'hover:bg-h-background',
      ]"
    >
      <svg
        :class="[edit ? 'text-dark' : 'text-primary']"
        xmlns="http://www.w3.org/2000/svg"
        height="40px"
        viewBox="0 -960 960 960"
        width="40px"
    ...
    <button
      ...
      :class="[
        'px-2 py-2',
        dark ? 'bg-accent hover:bg-h-accent' : 'hover:bg-h-background',
      ]"
    >
      <svg
        v-if="dark"
    ...
    >
      <svg
        :class="[router.path === '/calendar' ? 'text-dark' : 'text-primary']"
        xmlns="http://www.w3.org/2000/svg"
        height="40px"
        viewBox="0 -960 960 960"
        width="40px"

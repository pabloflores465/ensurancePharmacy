  ...
  >
    <div class="card mb-6">
      ...
      <div class="responsive-grid">
        <div v-for="user in users" :key="user.cui" class="bg-s-background hover:bg-h-secondary mb-6 rounded-lg px-4 py-4 cursor-pointer" @click="selectUser(user)">
          <div class="flex items-center mb-4">
            <div class="h-16 w-16 bg-accent rounded-full flex items-center justify-center text-white text-xl font-bold mr-4">
              {{ user.name.charAt(0) }}
            </div>
            <div>
          ...
          <div v-if="viewMode === 'detail'">
            ...
            <div class="mt-6 border-t pt-4">
              ...
              <div v-for="prescription in user.prescriptions" :key="prescription.id" class="text-secondary text-sm mb-2">
            ...
            <div class="mt-4 border-t pt-4">
              ...
              <div v-for="appointment in user.appointments" :key="appointment.number" class="text-secondary text-sm mb-2">
                <div class="flex justify-between">

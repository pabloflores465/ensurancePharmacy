...
<template>
  ...
  >
    <div
      ...
      class="card gap-4 max-sm:mx-2 max-sm:flex-col md:grid md:grid-flow-row md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"
    >
      <p class="text-title title mb-4">Hospital: {{ prescription.hospital }}</p>
